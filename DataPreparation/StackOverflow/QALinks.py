...
# QA tagged Git (first 300 pages)
urls = [f"https://stackoverflow.com/questions/tagged/git?tab=votes&page={i}&pagesize=50" for i in range(1, 301)]

# QA tagged GitLab (first 300 pages)
# urls = [f"https://stackoverflow.com/questions/tagged/gitlab?tab=votes&page={i}&pagesize=50" for i in range(1, 301)]

# QA tagged GitHub (first 300 pages)
# urls = [f"https://stackoverflow.com/questions/tagged/github?tab=votes&page={i}&pagesize=50" for i in range(1, 301)]
